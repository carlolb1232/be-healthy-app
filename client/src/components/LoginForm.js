...
import styles from "../views/styles_modules/CreateAdmin.module.css"
          ...
          return (
            <div className={styles.form_contain} >
              <Form className="contact" method="post" onSubmit={handleSubmit}>
                ...
                <br></br>
                <button className={styles.btn_crearAdmmin} type="submit" disabled={Object.values(errors).length > 0}>Login</button>
              </Form>
            </div>
          );
        }}
